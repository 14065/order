...
#End Region
    ...
    '［検索］－［顧客ID］メニュー
    '
    Private Sub mnuEditFindID_Click(sender As Object, e As EventArgs) Handles mnuEditFindID.Click
    ...
    '［検索］－［電話番号］メニュー
    '
    Private Sub mnuEditFindTel_Click(sender As Object, e As EventArgs) Handles mnuEditFindTel.Click
        Dim fm As New frmDialog()   '検索フォーム
        Dim flg As Boolean    '見つかったかどうか
        Dim i As Integer      'カウンタ
